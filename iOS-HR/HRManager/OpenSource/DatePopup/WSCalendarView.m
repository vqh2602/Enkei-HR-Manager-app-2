...
-(void)initializeMonthYear
{
    ...
    [self setMonthLabels:[NSDate date]];
}
...
- (IBAction)PrevClicked:(id)sender {
    ...
    [self setMonthLabels:datein];
    [self removeLabelCircle:datein];
    NSArray *currentDateStrings = [[monthFormatter stringFromDate:[NSDate date]] componentsSeparatedByString:@" "];
    NSArray *dateInStrings = [[monthFormatter stringFromDate:datein] componentsSeparatedByString:@" "];

    if ([currentDateStrings[1] isEqualToString:dateInStrings[1]] && [currentDateStrings[2] isEqualToString:dateInStrings[2]]) {
        [self highlightToday];
    }
}
