...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _backgroundColors[@(FSCalendarCellStateEvent)]       = FSCalendarStandardEventColor;
        ...
        _titleColors[@(FSCalendarCellStateEvent)]       = [UIColor whiteColor];
        
        _subtitleColors = [NSMutableDictionary dictionaryWithCapacity:6];
        ...
        _subtitleColors[@(FSCalendarCellStateEvent)]       = [UIColor whiteColor];
