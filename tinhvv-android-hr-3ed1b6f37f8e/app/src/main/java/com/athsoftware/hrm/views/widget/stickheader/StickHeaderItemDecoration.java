package com.athsoftware.hrm.views.widget.stickheader;
...
public class StickHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int mStickMarginLeft = 0;
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (headerPos >= 0) {
            ...
            mStickMarginLeft = parent.getPaddingStart();
    ...
    private void drawHeader(Canvas c, View header) {
        c.save();
        c.translate(mStickMarginLeft,  0);
        header.draw(c);
        c.restore();
    }
    ...
    private void moveHeader(Canvas c, View currentHeader, View nextHeader) {
        c.save();
        c.translate(mStickMarginLeft, nextHeader.getTop() - currentHeader.getHeight());
