...
public abstract class BaseView extends View implements View.OnClickListener,
    ...
    protected Paint mEventTextPaint = new Paint();
    ...
    protected Paint mEventPaint = new Paint();
    ...
    protected Paint mHolidayTextPaint = new Paint();
    ...
    private void initPaint(Context context) {
        ...
        mEventTextPaint.setColor(0xFFFFFFFF);
        mEventTextPaint.setFakeBoldText(true);
        mEventTextPaint.setTextSize(CalendarUtil.dipToPx(context, TEXT_SIZE));

        mHolidayTextPaint.setAntiAlias(true);
        mHolidayTextPaint.setTextAlign(Paint.Align.CENTER);
        mHolidayTextPaint.setColor(Color.parseColor("#FD2803"));
        mHolidayTextPaint.setFakeBoldText(true);
        mHolidayTextPaint.setTextSize(CalendarUtil.dipToPx(context, TEXT_SIZE));
        ...
        mEventPaint.setColor(Color.parseColor("#FD2803"));

        mHighlightPaint.setAntiAlias(true);
        mHighlightPaint.setStyle(Paint.Style.FILL);
        mHighlightPaint.setStrokeWidth(2);
        mHighlightPaint.setColor(Color.parseColor("#3039a4e7"));
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        this.mEventTextPaint.setTextSize(delegate.getDayTextSize());
    ...
    final void addSchemesFromMap() {
        ...
        for (Calendar a : mItems) {
            if (mDelegate.mSchemeDatesMap.containsKey(a.toString())) {
                ...
                a.setScheme(
                    TextUtils.isEmpty(d.getScheme()) ? mDelegate.getSchemeText() : d.getScheme());
