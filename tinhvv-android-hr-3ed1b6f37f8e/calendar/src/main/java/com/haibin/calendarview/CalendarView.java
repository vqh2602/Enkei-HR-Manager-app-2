...
public class CalendarView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        FrameLayout.LayoutParams lineParams = (FrameLayout.LayoutParams) this.mWeekLine
            .getLayoutParams();
        ...
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) this.mMonthPager
            .getLayoutParams();
        ...
        mDelegate.mInnerListener = new OnInnerDateSelectedListener() {
            ...
            public void onMonthDateSelected(Calendar calendar, boolean isClick) {
                ...
                if (mDelegate
                    .getSelectMode() == CalendarViewDelegate.SELECT_MODE_DEFAULT || isClick) {
            ...
            public void onWeekDateSelected(Calendar calendar, boolean isClick) {
                ...
                int position = 12 * y + mDelegate.mIndexCalendar.getMonth() - mDelegate
                    .getMinYearMonth();
        ...
        mYearViewPager.setOnMonthSelectedListener(new YearRecyclerView.OnMonthSelectedListener() {
            ...
            public void onMonthSelected(int year, int month) {
                int position = 12 * (year - mDelegate.getMinYear()) + month - mDelegate
                    .getMinYearMonth();
    ...
    private void closeSelectLayout(final int position) {
        ...
        if (position == mMonthPager.getCurrentItem()) {
            if (mDelegate.mCalendarSelectListener != null &&
                ...
                mDelegate.mCalendarSelectListener
                    .onCalendarSelect(mDelegate.mSelectedCalendar, false);
            }
        } else {
            mMonthPager.setCurrentItem(position, false);
        }
    ...
    public final void setOnCalendarInterceptListener(OnCalendarInterceptListener listener) {
        ...
        if (listener == null || mDelegate
            .getSelectMode() == CalendarViewDelegate.SELECT_MODE_DEFAULT) {
            return;
        }
    ...
    public final void setSelectCalendarRange(Calendar startCalendar, Calendar endCalendar) {
        ...
        if (mDelegate.getMinSelectRange() == -1 && minDiffer == 0) {
            ...
            scrollToCalendar(startCalendar.getYear(), startCalendar.getMonth(),
    ...
    public void setYearViewTextColor(int yearViewMonthTextColor, int yearViewDayTextColor,
        ...
        mDelegate.setYearViewTextColor(yearViewMonthTextColor, yearViewDayTextColor,
    ...
    public void setListEvents(List<Calendar> events) {
        mDelegate.mHasEventDays = events;
    }

    public void setHighlightEvents(List<Calendar> events) {
        mDelegate.mHighlightDays = events;
    }

    public void setLeaveDate(List<Calendar> events) {
        mDelegate.mLeaveDays = events;
    }

    public boolean isEvent(Calendar calendar) {
        return mDelegate.isHasEvent(calendar);
    }
