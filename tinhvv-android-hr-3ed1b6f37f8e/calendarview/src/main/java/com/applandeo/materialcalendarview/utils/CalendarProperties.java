...
public class CalendarProperties {
    ...
    private List<Calendar> mHasEventDays = new ArrayList<>();

    private List<Calendar> mHighlightDays = new ArrayList<>();
    ...
    public void setOnSelectionAbilityListener(
    ...
    public void setOnPreviousPageChangeListener(
        OnCalendarPageChangeListener onPreviousButtonClickListener) {
    ...
    public void setOnForwardPageChangeListener(
        OnCalendarPageChangeListener onForwardButtonClickListener) {
    ...
    public List<Calendar> getHasEventDays() {
        return mHasEventDays;
    }

    public void setHasEventDays(List<Calendar> disabledDays) {
        mHasEventDays = Stream.of(disabledDays).map(calendar -> {
            DateUtils.setMidnight(calendar);
            return calendar;
        }).toList();
    }
    ...
    public List<Calendar> getHighlightDays() {
        return mHighlightDays;
    }

    public void setmHighlightDays(List<Calendar> mHighlightDays) {
        this.mHighlightDays = Stream.of(mHighlightDays).map(calendar -> {
            DateUtils.setMidnight(calendar);
            return calendar;
        }).toList();
    }
