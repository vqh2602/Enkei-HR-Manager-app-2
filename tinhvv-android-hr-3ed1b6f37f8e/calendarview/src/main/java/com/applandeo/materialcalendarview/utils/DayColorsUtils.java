...
public class DayColorsUtils {
     ...
     */
    public static void setDayColors(TextView textView, int textColor, int typeface,
        int background) {
        if (textView == null) {
            return;
        }
    ...
    public static void setCurrentMonthDayColors(Calendar day, Calendar today, TextView dayLabel,
        CalendarProperties calendarProperties, boolean isHasEvent) {
        if (today.equals(day)) {
            setDayColors(dayLabel,
                isHasEvent ? calendarProperties.getSelectionLabelColor() : calendarProperties
                    .getTodayLabelColor(), Typeface.BOLD,
                isHasEvent ? R.drawable.red_circle_selector : R.drawable.background_transparent);
        } else {
            setDayColors(dayLabel,
                isHasEvent ? calendarProperties.getSelectionLabelColor() : calendarProperties
                    .getDaysLabelsColor(), Typeface.NORMAL,
                isHasEvent ? R.drawable.red_circle_selector : R.drawable.background_transparent);
        }
    }
}
