...
public class DayRowClickListener implements AdapterView.OnItemClickListener {
    ...
    public DayRowClickListener(CalendarPageAdapter calendarPageAdapter,
        CalendarProperties calendarProperties, int pageMonth) {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
        ...
        switch (mCalendarProperties.getCalendarType()) {
            ...
            case CalendarView.BIIN_DOT_EVENT:
    ...
    private void reverseUnselectedColor(SelectedDay selectedDay) {
        DayColorsUtils.setCurrentMonthDayColors(selectedDay.getCalendar(),
            DateUtils.getCalendar(), (TextView) selectedDay.getView(), mCalendarProperties, isHasEvent(selectedDay.getCalendar()));
    }
    ...
    private boolean isBetweenMinAndMax(Calendar day) {
        return !((mCalendarProperties.getMinimumDate() != null && day
    ...
    private void callOnClickListener(EventDay eventDay) {
        ...
        eventDay.setHasEvent(isHasEvent(eventDay.getCalendar()));
