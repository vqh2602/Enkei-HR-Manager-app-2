...
public class CalendarPageAdapter extends PagerAdapter {
    ...
    public CalendarPageAdapter(Context context, CalendarProperties calendarProperties) {
        ...
        if (mCalendarProperties.getCalendarType() == CalendarView.ONE_DAY_PICKER || mCalendarProperties.getCalendarType() == CalendarView.BIIN_DOT_EVENT) {
...
//        Calendar calendar = (Calendar) mCalendarProperties.getCurrentDate().clone();
        ...
        calendar.add(Calendar.MONTH, position - CalendarView.FIRST_VISIBLE_PAGE);
